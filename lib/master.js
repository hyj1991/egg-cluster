...
const WorkerThreadsAgentWorker = require('./utils/start_mode/worker_threads/agent');
const WorkerThreadsAppWorker = require('./utils/start_mode/worker_threads/app');
const { canIuseWorkerThreads } = require('./utils/start_mode/worker_threads/utils');
...
class Master extends EventEmitter {
  ...
  constructor(options) {
    ...
    if (canIuseWorkerThreads && this.options.startMode === 'worker_threads') {
