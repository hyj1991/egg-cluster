...
let AgentWorker;
if (canIuseWorkerThreads && options.startMode === 'worker_threads') {
  AgentWorker = require('./utils/start_mode/worker_threads/agent').AgentWorker;
} else {
  AgentWorker = require('./utils/start_mode/process/agent').AgentWorker;
}
